...
@GenerateMocks([WatchlistDataSource])
void main() {
  ...
  group('save watchlist', () {
    test('should return success message when saving successful', () async {
      // arrange
      when(mockWatchlistDataSource.insertWatchlist(testMovieTable, 'movies'))
  ...
  group('remove watchlist', () {
    test('should return success message when remove successful', () async {
      // arrange
      when(mockWatchlistDataSource.removeWatchlist(testMovieTable, 'movies'))
  ...
  group('get watchlist status', () {
    test('should return watch status whether data is found', () async {
      // arrange
      final tId = 1;
      when(mockWatchlistDataSource.getWatchlistById(tId, 'movies'))
