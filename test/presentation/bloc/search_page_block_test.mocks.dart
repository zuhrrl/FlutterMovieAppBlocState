...
// in ditonton/test/presentation/bloc/search_page_block_test.dart.
...
import 'package:ditonton/domain/usecases/search_tvs.dart' as _i9;
...
class MockSearchMovies extends _i1.Mock implements _i5.SearchMovies {
  ...
  @override
  _i6.Future<_i3.Either<_i7.Failure, List<_i8.SearchResult>>> execute(
          String? query) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
        ...
        returnValue:
            _i6.Future<_i3.Either<_i7.Failure, List<_i8.SearchResult>>>.value(
                _FakeEither_1<_i7.Failure, List<_i8.SearchResult>>(
          this,
          Invocation.method(
            #execute,
            [query],
      ...
      ) as _i6.Future<_i3.Either<_i7.Failure, List<_i8.SearchResult>>>);
}
